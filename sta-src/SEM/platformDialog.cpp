...
bool PlatformDialog::loadValues(ScenarioSCSystemType* spacecraftPlatformSystem)
{
    ...
    Ixy->setText(QString::number(spacecraftPlatformSystem->Structure()->SecondMomentsOfInertia()->xAxis()));
    Ixz->setText(QString::number(spacecraftPlatformSystem->Structure()->SecondMomentsOfInertia()->yAxis()));
    Iyz->setText(QString::number(spacecraftPlatformSystem->Structure()->SecondMomentsOfInertia()->zAxis()));
    Iyx->setText(QString::number(spacecraftPlatformSystem->Structure()->SecondMomentsOfInertia()->xAxis()));
    Izx->setText(QString::number(spacecraftPlatformSystem->Structure()->SecondMomentsOfInertia()->yAxis()));
    Izy->setText(QString::number(spacecraftPlatformSystem->Structure()->SecondMomentsOfInertia()->zAxis()));
...
bool PlatformDialog::saveValues(ScenarioSCSystemType* spacecraftPlatformSystem)
{
    ...
    spacecraftPlatformSystem->Structure()->SecondMomentsOfInertia()->setXAxis(Ixy->text().toDouble());
    spacecraftPlatformSystem->Structure()->SecondMomentsOfInertia()->setYAxis(Ixz->text().toDouble());
    spacecraftPlatformSystem->Structure()->SecondMomentsOfInertia()->setZAxis(Iyz->text().toDouble());
    //spacecraftPlatformSystem->Structure()->SecondMomentsOfInertia()->setXAxis(Iyx->text().toDouble());
    //spacecraftPlatformSystem->Structure()->SecondMomentsOfInertia()->setYAxis(Izx->text().toDouble());
    //spacecraftPlatformSystem->Structure()->SecondMomentsOfInertia()->setZAxis(Izy->text().toDouble());
