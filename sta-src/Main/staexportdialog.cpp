...
staExportDialog::staExportDialog(PropagatedScenario* scenario, QWidget* parent) :
    QDialog(parent),
    m_scenario(scenario)
{
    setupUi(this);
...
staExportDialog::~staExportDialog()
{
}


bool
staExportDialog::exportTrajectory(QIODevice* out)
{
