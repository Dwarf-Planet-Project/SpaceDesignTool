...
#include "Constellations/analysisprop.h"
#include <QMessageBox>
#include <QObject>
...
{
    public:
    Antenna(double az, double el, double ang):
            m_elevation(el),
            m_azimuth(az)
    {
...
class AnaSpaceObject
{
    public:
        AnaSpaceObject(SpaceObject* spaceObject, Antenna* obsAnt);
        ~AnaSpaceObject();
