...
Analysis::Analysis(PropagatedScenario* scenario):
...
CoverageAnalysis::CoverageAnalysis(PropagatedScenario* scenario, bool m_calcCoverage, bool m_calcSOLink, bool m_calcGOLink)
        //m_askfeature(new AnalysisPropDialog(NULL))
{
    // analysis features dialog
    //m_askfeature->exec();
