...
lagrangianDialog::lagrangianDialog(MainWindow* parent) : mainwindow(parent)
{
	setupUi(this);
}
...
void lagrangianDialog::on_buttonBox_accepted()
{
...
void lagrangianDialog::on_buttonBox_rejected()
{
