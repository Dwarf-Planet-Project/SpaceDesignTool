...
void FitDialog::saveUserFunction()
{
	...
	if (lst.contains(name)){
		...
		filter += tr("All files")+" (*.*)";
		QString fn = QFileDialog::getSaveFileName(app, tr("Analysis") + " - " + tr("Save Fit Model As"),
...
void FitDialog::removeUserFunction()
{
    ...
    if (QMessageBox::Yes != QMessageBox::question (this, tr("Analysis") + " - " + tr("Remove Fit Model"), s, QMessageBox::Yes, QMessageBox::Cancel))
        return;
