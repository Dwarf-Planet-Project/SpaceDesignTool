...
// Patched by Guillermo June 9th 2009
...
{
    // Pathced by Guillermo to avoid unnecessary logs
...
FragmentProcessor* fp::initNV()
{
    ...
    // Debug lines patched by Guillermo to avoid unnecessary logs
...
{
    // Next line patched by Guilermo to take away the console trace of the vertex loading
