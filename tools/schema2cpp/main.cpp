...
// TODO: should have a table of exceptions
// rather than a special case for the root element.
QString classNameFromElement(QString elementName)
{
    if (elementName == "SpaceScenario")
        return elementName;
    else
        return CLASS_PREFIX + elementName;
}
...
public:
    ...
    {
        return classNameFromElement(name());
    }
